from .views import user_creation, genre_create_api, GenreDetail, MediaDetail, MediaListCreate, render_comrades, \
    check_if_logged_in
...
urlpatterns = [
    ...
    url(r'^media/list/create/$', MediaListCreate.as_view()),
